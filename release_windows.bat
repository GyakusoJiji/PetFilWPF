...
rem **  PetFil file for Windows 10 and 11.                                            **
rem **                                                                                **
...
pyi-makespec -F --name "PetFil" --add-data "printrun/assets;printrun/assets" -w -i "./assets_raw/icons/pronterface.ico" petfil.py

echo *******************************************
echo ****** Build PetFil executable       ******
echo *******************************************
pyinstaller --clean PetFil.spec -y
...
echo ******                                                   ******
echo ******    Happy filament making with PetFil for Windows!    ******
echo ******                                                   ******
echo ****** You will find PetFil and localizations here:      ******
echo ***************************************************************
cd dist
dir .
pause
